...
class MaxFilesSizeValidator(BaseValidator):
    def clean(self, x):
        return x.size
...
def validate_image_size_less_then_5mb(value):
...
class PetPhoto(models.Model):
    ...
    photo = models.ImageField(
        ...
        null=False,
        validators=(
            validate_image_size_less_then_5mb,
            # MinLengthValidator(limit_value=SIZE_5_MB)
        )
    )
    ...
    modified_ad = models.DateTimeField(
        auto_now=True,
    )